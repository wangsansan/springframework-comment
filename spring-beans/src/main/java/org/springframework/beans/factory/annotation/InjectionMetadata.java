...
public class InjectionMetadata {
	...
	/**
	 * 这个方法感觉是把injectedElements的数据拷贝到了checkedElements里面
	 * 个人理解，也许spring是怕有程序员在一个service里面注入同样类型的属性多遍，不要笑，我在开发过程中见到过这样的代码
	 * 但是如果仅仅是为了去重，为什么不直接把injectedElements变为修饰成为set类型
